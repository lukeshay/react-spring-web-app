...
class GymControllerTest {
  ...
  @Autowired
  PrivateGymController privateGymController;

  @Autowired
  PublicGymController publicGymController;
  ...
  @BeforeEach
  void setUp() {
    testGym = new Gym("Jim", "street", "city", "state", "lukeshay.com", "climbing@gym.com",
        "phoneNumber", null);
  ...
  void updateGymByIdTest() {
    ResponseEntity<?> response = privateGymController.updateGym(testGym.getId(), "Jimmy", null, null, null, null, null, null);
